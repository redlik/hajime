    ...
    <main class="sm:container sm:mx-auto sm:mt-10">
        <div class="w-full sm:px-6">
            ...
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                ...
                text-xl">
                    <i class="fas fa-sticky-note mr-2 text-gray-200"></i> Add new note
                </header>
                ...
                <div class="w-full p-6">
                    ...
                    @endif
                    <form method="POST" action="{{ action('App\Http\Controllers\ClubnoteController@store') }}"
                          role="form">
                        @csrf
                        ...
                        <div class="w-full border-2 border-gray-300 rounded-xl p-8 mb-4">
                            <div class="mb-4">
                                <label class="inline-block w-24 text-gray-600 text-sm font-bold mb-2" for="title">
                                    Title
                                </label>
                                <input
                            ...
                            <div class="mb-4 flex items-start">
                                <label class="inline-block w-24 text-gray-600 text-sm font-bold mb-2" for="body">
                                    Body
                                </label>
                            ...
                            <div class="mt-6">
                                <input type="submit" value="+ Add new note" class="button-judo ml-24">
                            </div>
                        </div>
