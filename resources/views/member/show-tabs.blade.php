...
<main class="sm:container sm:mx-auto sm:mt-10">
    <div class="w-full sm:px-6">
        ...
        <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
            ...
            <div id="main" x-data="{ openTab: 1}">
                {{-- TABS SECTION --}}
                <div class="w-full px-6 ">
                    <ul class="flex border-b">
                        <li class="-mb-px mr-1" @click="openTab = 1">
                            <a class="bg-gray-100 text-xl inline-block border-l border-t border-r rounded-t py-2 px-4 text-blue-700 font-semibold" href="#">Personal Details</a>
                        </li>
                        <li class="-mb-px mr-1" @click="openTab = 2">
                            <a class="bg-white text-xl inline-block border-l border-t border-r rounded-t py-2 px-4 text-gray-500 font-semibold" href="#">Membership</a>
                        </li>
                        <li class="-mb-px mr-1" @click="openTab = 3">
                            <a class="bg-white text-xl inline-block border-l border-t border-r rounded-t py-2 px-4 text-gray-500 font-semibold" href="#">Grading</a>
                        </li>
                        <li class="-mb-px mr-1" @click="openTab = 4">
                            <a class="bg-white text-xl inline-block border-l border-t border-r rounded-t py-2 px-4 text-gray-500 font-semibold" href="#">Notes</a>
                        </li>
                        <li class="-mb-px mr-1" @click="openTab = 5">
                            <a class="bg-white text-xl inline-block border-l border-t border-r rounded-t py-2 px-4 text-gray-500 font-semibold" href="#">Forms</a>
                        </li>
                        <li class="-mb-px mr-1" @click="openTab = 6">
                            <a class="bg-white text-xl inline-block border-l border-t border-r rounded-t py-2 px-4 text-gray-500 font-semibold" href="#">Documents</a>
                        </li>
                        
                    </ul>
                </div>
                {{-- PERSONAL DETAILS  SECTION --}}
                <div class="w-full p-6" x-show="openTab === 1">
                ...
                {{-- MEMBERSHIP SECTION --}}
                <div class="w-full border-2 border-gray-300 rounded-xl my-4 p-4" x-show="openTab === 2">
                ...
                {{-- GRADING SECTION --}}
                <div class="w-full border-2 border-gray-300 rounded-xl my-4 p-4" x-show="openTab === 3">
                ...
                {{-- NOTES SECTION --}}
                <div class="w-full border-2 border-gray-300 rounded-xl my-4 p-4" x-show="openTab === 4">
                ...
                <!-- Forms Section -->
                <div class="w-full border border-gray-300 rounded-xl my-4 p-4" x-show="openTab === 5">
                ...
                <!-- Documents Section -->
                <div class="w-full border border-gray-300 rounded-xl my-4 p-4" x-show="openTab === 6">
