<template @gradingModal.window="gradingModal = true" x-if="gradingModal">
    <div @keydown.window.escape="gradingModal = false" x-show="gradingModal"
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div x-show="gradingModal" x-transition:enter="ease-out duration-300"
                 ...
                 @click="gradingModal = false" aria-hidden="true">
            </div>
            ...
            <div x-show="gradingModal" x-transition:enter="ease-out duration-300"
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    ...
                    <a>
                        <button type="button"
                                class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-judo-600 text-base font-medium text-white hover:bg-judo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-judo-500 sm:ml-3 sm:w-auto sm:text-sm"
