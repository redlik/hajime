            ...
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                ...
                <div class="w-full px-6">
                                        ...
                                        <div class="flex items-center">
                                            <div>
                                                <p class="text-gray-900 whitespace-no-wrap font-bold">{{ $venue->contact }}
                                                    <br><span
                                                        class="font-bold text-gray-500">t:</span>{{ $venue->phone }}</p>
                                            </div>
                                        </div>
                                    </td>
                    ...
                    <div class="w-full border border-gray-300 rounded-xl my-4 p-4 flex flex-wrap">
                        ...
                        <div
                            x-data="{headCoach: false, secretary: false, designated: false, childrens:false, coach: false}"
                            x-cloak class="w-full flex flex-wrap">
                            ...
                            <div class="w-full md:w-1/2">
                                <div class="w-full mb-3">
                                        ...
                                        <div class="w-auto inline-block font-bold mb-2 p-2 text-right">
                                            <button type="button" title="View details"
                                                ...
                                                <i class="far fa-eye text-green-500 mr-2"
                                                   :class="{ 'text-gray-300' : headCoach, 'text-green-500' : ! headCoach}"></i>
                                            </button>
                                    ...
                                    @endif
                                    <div x-show="headCoach" @keydown.escape="headCoach = false"
                                         class="p-2 bg-green-100 rounded w-auto flex flex-wrap shadow-lg relative">
                                ...
                                <div class="w-full mb-3">
                                    ...
                                    @if ($secretary)
                                        <div class="w-auto inline-block font-bold mb-2 p-2 text-right">
                                            <button type="button" title="View details"
                                                ...
                                                <i class="far fa-eye text-green-500 mr-2"
                                                   :class="{ 'text-gray-300' : secretary, 'text-green-500' : ! secretary}"></i>
                                            </button>
                                    ...
                                    @endif
                                    <div x-show="secretary" @keydown.escape="secretary = false"
                                         class="p-2 bg-green-100 rounded w-auto flex flex-wrap shadow-lg relative">
                                        <div class="absolute right-2">
                            ...
                            <div class="w-full md:w-1/2">
                                <div class="w-full mb-3">
                                    <div class="w-36 inline-block font-bold mb-2 text-gray-500 p-2">Designated Off:
                                    </div>
                                    <div class="w-56 bg-gray-100 p-2 rounded inline-block font-semibold">
                                    ...
                                    @if ($designated)
                                        <div class="w-auto inline-block font-bold mb-2 p-2 text-right">
                                            <button type="button" title="View details"
                                                ...
                                                <i class="far fa-eye text-green-500 mr-2"
                                                   :class="{ 'text-gray-300' : designated, 'text-green-500' : ! designated}"></i>
                                            </button>
                                    ...
                                    @endif
                                    <div x-show="designated" @keydown.escape="designated = false"
                                         class="p-2 bg-green-100 rounded w-auto flex flex-wrap shadow-lg relative">
                                        <div class="absolute right-2">
                                ...
                                <div class="w-full mb-3">
                                    ...
                                    @if ($childrens)
                                        <div class="w-auto inline-block font-bold mb-2 p-2 text-right">
                                            <button type="button" title="View details"
                                                ...
                                                <i class="far fa-eye text-green-500 mr-2"
                                                   :class="{ 'text-gray-300' : childrens, 'text-green-500' : ! childrens}"></i>
                                            </button>
                                    ...
                                    @endif
                                    <div x-show="childrens" @keydown.escape="childrens = false"
                                         class="p-2 bg-green-100 rounded w-auto flex flex-wrap shadow-lg relative">
                                        <div class="absolute right-2">
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    $coach->safeguarding_completion ?? 'Not set' }}</div>
                                                        @if ( $coach->safeguarding_expiry)
                                                            ...
                                                            @endif
                                                        @else
                                                            <div class="bg-gray-200 text-gray-600 rounded-lg py-1 px-2">
                                                                Not
                                                                set
                                                            </div>
                                                        @endif
                                                    ...
                                                    <div>
                                                        ...
                                                        @if ( $coach->first_aid_expiry)
                                                            @if($coach->first_aid_expiry < now())
                                                                <div class="bg-red-700 text-white rounded-lg py-1 px-2">{{ $coach->first_aid_expiry }}</div>
                                                            @else
                                                                <div class="bg-indigo-100 rounded-lg py-1 px-2">{{
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-5 py-5 border-b border-gray-200 text-sm">
                                                <div class="flex items-center">
                                                    <div>
                                                        <span
                                                            class="font-bold text-gray-500">e:</span> {{ $volunteer->email }}
                                                        <br><span
                                                            class="font-bold text-gray-500">t:</span>{{ $volunteer->phone }}
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-5 py-5 border-b border-gray-200 text-sm">
                            ...
                            <table class="min-w-full table leading-normal mt-8">
                                ...
                                @foreach ($documents as $document)
                                    <tr>
                                        ...
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm flex flex-wrap">
                                            <form action="{{ route('clubdoc.destroy', $document->id) }}" method="POST">
                                                @csrf
                                                <input type="hidden" name="_method" value="DELETE"/>
                                                <button type="submit"
                                                        class="text-red-600 hover:text-red-300 whitespace-no-wrap ml-3"
